...
function AppContent() {
  ...
  // Hide the main site navbar on pages that have their own nav
  const hideNavbarRoutes = ['/', '/login', '/signup'];
  const showNavbar = navbarVisible && !hideNavbarRoutes.includes(location.pathname);
    ...
    <div>
      ...
      <div>
        <Routes>
          ...
          <Route path="/settings" element={<Settings />} />
          <Route path="/profile" element={<Profile />} />
          <Route path="/payment" element={<RazorpayHome />} />
